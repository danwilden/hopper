# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-04-20 00:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='demoapp.Family')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='demoapp.Location')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
